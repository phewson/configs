...
* Teaching
- [ ] Jimmy's tutees
- [ ] Speak to Abby about engagement
  - [ ] Propose course on Product Analytics (short course)
- [ ] Update MTHM503 for new delivery, bug fix, find new applications
...
** INPROGRESS Select committee submission
...
** Database imports
- [X] Write R package to help create DDL / Importers for STATs19
